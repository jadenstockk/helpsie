...
module.exports = {
    ...
    callback: async (message, args, client) => {
      ...
      if (xp > 20000) return message.channel.send(new Discord.MessageEmbed().setDescription(`${nopeEmoji} You can't add more than 20k xp to a member at once`).setColor("#FF3E3E"));
