...
module.exports = {
  ...
  callback: (message, args, client) => {
    ...
    message.channel.awaitMessages(m => m.author.id === message.author.id,
        {max: 1, time: 10000}).then(channelCollected => {
            ...
            channelCollected.first().delete();
                        ...
                        message.channel.awaitMessages(m => m.author.id === message.author.id,
                            { max: 1, time: 60000 }).then(titleCollected => {
                                ...
                                message.channel.awaitMessages(m => m.author.id === message.author.id,
                                    { max: 1, time: 120000 }).then(descriptionCollected => {
                                        ...
                                        message.channel.awaitMessages(m => m.author.id === message.author.id,
                                            {max: 1, time: 60000}).then(footerCollected => {
                                                ...
                                                message.channel.awaitMessages(m => m.author.id === message.author.id,
                                                    { max: 1, time: 120000 }).then(async colourCollected => {
                                                        ...
                                                        mainMsg.awaitReactions(((reaction, user) => user.id === message.author.id && (reaction.emoji === checkEmoji || reaction.emoji ===  nopeEmoji)),
                                                            { max: 1, time: 120000 }).then(sendCollected => {
